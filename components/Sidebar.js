  ...
  return (
    <div className="hidden sm:flex flex-col p-2 xl:items-start fixed h-full">
      ...
      <div className="hoverEffect text-gray-700 flex items-center justify-center xl:justify-start mt-auto">
        <img
          src="https://pps.whatsapp.net/v/t61.24694-24/322237123_1226998274609698_5772647054370202875_n.jpg?ccb=11-4&oh=01_AdRsNEMhziT6GJJ4qAKVPlbglkfRqfawrqvzUNSqH-eykw&oe=640DD534"
          alt="user-img"
          className="w-10 h-10 rounded-full xl:mr-2"
        />
        <div className="leading-5 hidden xl:inline">
          <h4 className="font-bold">Manthan Sharma</h4>
          <p className="text-gray-500">@manthanSharma</p>
        </div>
